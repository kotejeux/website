 ...
 */
final class Version20201223161901 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE jeu ADD copies INT NOT NULL, CHANGE editeur_id editeur_id INT DEFAULT NULL, CHANGE annee annee INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON NOT NULL, CHANGE connection_token connection_token VARCHAR(32) DEFAULT NULL, CHANGE last_connection last_connection DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE jeu DROP copies, CHANGE editeur_id editeur_id INT DEFAULT NULL, CHANGE annee annee INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`, CHANGE connection_token connection_token VARCHAR(32) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE last_connection last_connection DATE DEFAULT \'NULL\'');
    }
}
