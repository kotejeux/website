 ...
 */
final class Version20201118000013 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE editeur (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, creation_year INT DEFAULT NULL, nationalite VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jeu (id INT AUTO_INCREMENT NOT NULL, editeur_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, joueurs_min INT NOT NULL, joueurs_max INT NOT NULL, duree INT NOT NULL, annee INT DEFAULT NULL, INDEX IDX_82E48DB53375BD21 (editeur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, personne_id INT DEFAULT NULL, jeu_id INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, paye TINYINT(1) NOT NULL, nom VARCHAR(255) NOT NULL, mail VARCHAR(255) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, ok TINYINT(1) NOT NULL, INDEX IDX_5E9E89CBA21BD112 (personne_id), INDEX IDX_5E9E89CB8C9E392E (jeu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
